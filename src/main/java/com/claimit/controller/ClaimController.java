...
public class ClaimController {
	...
	public ResponseEntity<Map<String, Object>> updateClaimRequest(@RequestBody ClaimRequest claimReques) {
		Map<String, Object> response = claimService.updateClaimRequest(claimReques);
		return ResponseEntity.ok(response);
	}
	...
	public Map<String, Object> claimItem(@RequestBody ClaimRequestDTO claimRequest) {
		return claimService.claimItem(claimRequest);
	...
	public Map<String, Object> approveOrRejectRequest(@RequestParam int itemId, @RequestParam ItemStatus status,
		...
		return claimService.approveOrRejectRequest(itemId, status, rejectedReason);
	}
	...
	public ResponseEntity<Map<String, Object>> submitClaim(@RequestBody ClaimRequest claimRequest) {
		...
		try {
			ClaimRequest savedRequest = claimService.submitRequest(claimRequest);
